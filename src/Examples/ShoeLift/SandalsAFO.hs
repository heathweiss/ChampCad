...
This gets converted to a width system so it works with Cubical.
Maybe Cubical should have both systems?
-}
--BottomFrontLine (Point ) ,
heelSandal :: [CornerPoints]
heelSandal =
  [ BackTopLine (Point  40   99.8  133.7)   (Point 50   99.9  133.7),
    FrontTopLine (Point 40   99.9  133.7)   (Point 50   99.9  133.7),
    FrontTopLine (Point 40   100   133.7)   (Point 50   99.9  133.7),
...
sandalToe =
  [ 
    BackTopLine (Point 1.5  270   100)     (Point 90.5 270   100),
    FrontTopLine (Point 3.5  280   99.6)    (Point 91   280   99.6),
    FrontTopLine (Point 3.5  290   98.3)    (Point 89   290   98.3),
    FrontTopLine (Point 5.8  300   98.1)    (Point 83.5 300   98.1),
    FrontTopLine (Point 6.3  305   97.3)    (Point 79.5 305   97.3),
    FrontTopLine (Point 12.5 310   97.3)    (Point 78.5 310   97.3),
    FrontTopLine (Point 16   315   97.3)    (Point 77.5 315   97.3),
    FrontTopLine (Point 20   320   97.2)    (Point 73.5 320   97.2),
    FrontTopLine (Point 22.5 325   97.3)    (Point 68.5 325   97.3),
    FrontTopLine (Point 30   330   96.9)    (Point 63.5 330   96.9),
    FrontTopLine (Point 30.1 333   96.5)    (Point 60   333   96.5),
    FrontTopLine (Point 30.2 335   95.7)    (Point 56   335   95.7),
    FrontTopLine (Point 30   338   95.7)    (Point 41   338   95.7),
    FrontTopLine (Point 30   338.1 95.7)    (Point 41   338.1 95.7), 
    FrontTopLine (Point 30   338.2 95.7)    (Point 41   338.2 95.7)
  ]
...
treadToe =
  [ 
    BackBottomLine  (Point 5    270   44.9) (Point 90   270 44.9),
